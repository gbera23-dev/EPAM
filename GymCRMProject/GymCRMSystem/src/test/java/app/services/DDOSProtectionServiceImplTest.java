...
public class DDOSProtectionServiceImplTest {
    ...
    private app.services.DDOSProtectionServiceImpl service;

    @BeforeEach
    public void setup() {
        service = new app.services.DDOSProtectionServiceImpl();
    }
    ...
    public void testBlockUserAddsLockAndRemovesAttempts() throws Exception {
        ...
        Field attemptsField = app.services.DDOSProtectionServiceImpl.class.getDeclaredField("userAttemptCounts");
