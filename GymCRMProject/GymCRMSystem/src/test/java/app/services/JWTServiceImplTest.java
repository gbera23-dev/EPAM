...
import app.services.JWTServiceImpl;
...
public class JWTServiceImplTest {
    ...
    private app.services.JWTServiceImpl jwtService;
    private JWTRepository jwtRepository;

    @BeforeEach
    public void setup() throws Exception {
        jwtRepository = mock(JWTRepository.class);
        jwtService = new app.services.JWTServiceImpl(jwtRepository);
        String rawKey = "01234567890123456789012345678901";
        String base64Key = Base64.getEncoder().encodeToString(rawKey.getBytes());
        Field secretField = app.services.JWTServiceImpl.class.getDeclaredField("SECRET_KEY");
