package app.unit.domain.database;

import app.domain.database.DatabaseInitializer;
...
import app.infrastructure.mappers.GymMapper;
import app.infrastructure.mappers.TraineeMapper;
import app.infrastructure.mappers.TrainerMapper;
import app.infrastructure.mappers.TrainingMapper;
...
class DatabaseInitializerTest {
    ...
    @BeforeEach
    void setUp() {
        GymRepository repositories = new GymRepository(traineeRepository, trainerRepository, trainingRepository, trainingTypeRepository, userRepository, jwtRepository);
