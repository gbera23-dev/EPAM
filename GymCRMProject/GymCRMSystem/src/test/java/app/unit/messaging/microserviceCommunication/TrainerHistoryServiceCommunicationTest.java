package app.unit.messaging.microserviceCommunication;
...
class TrainerHistoryServiceCommunicationTest {

    @Mock private JmsTemplate jmsTemplate;
    @Mock private Message message;

    private TrainerHistoryServiceCommunication messaging;

    @BeforeEach
    void setUp() {
        messaging = new TrainerHistoryServiceCommunication(jmsTemplate);
    }
