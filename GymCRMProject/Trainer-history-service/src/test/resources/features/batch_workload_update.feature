...
Feature: Applying a batch trainer workload message
  ...
  Scenario: Several additions for one trainer and month are summed
    ...
    When the following batch workload message is sent to "training-batch-update-channel"
    ...
    Then the monthly summary for "john.doe" for month "2025-03" should eventually have duration 12
  ...
  Scenario: Additions and deletions in one month net out to a single addition
    ...
    Then the monthly summary for "john.doe" for month "2025-03" should eventually have duration 7
  ...
  Scenario: A batch with a negative net total removes hours from the stored summary
    ...
    Then the monthly summary for "john.doe" for month "2025-03" should eventually have duration 13
  ...
  Scenario: A net removal larger than the stored duration is rejected
    ...
    And the monthly summary for "john.doe" for month "2025-03" should still have duration 5
  ...
  Scenario: Different months of one trainer are not merged
    ...
    Then the monthly summary for "john.doe" for month "2025-03" should eventually have duration 3
    And the monthly summary for "john.doe" for month "2025-04" should eventually have duration 4
  ...
  Scenario: Different trainers in one month are not merged
    ...
    Then the monthly summary for "john.doe" for month "2025-03" should eventually have duration 3
    And the monthly summary for "jane.smith" for month "2025-03" should eventually have duration 4
  ...
  Scenario: An empty batch changes nothing
    ...
    When an empty batch workload message is sent to "training-batch-update-channel"
    Then the monthly summary for "john.doe" for month "2025-03" should still have duration 10
    And exactly 1 monthly summary should exist for "john.doe"
